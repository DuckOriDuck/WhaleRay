...
- 목표인 **100개 이상의 서비스를 안정적으로 배포**하는 플랫폼을 만들기 위해서는 AWS ALB의 리스너 규칙 개수 제한(50개)을 극복해야 했습니다. 이를 위해 고정적인 라우팅 규칙 대신 **Nginx와 AWS Cloud Map을 활용한 동적 서비스 디스커버리 패턴**을 구현하여 무제한 확장이 가능한 구조를 설계했습니다.
